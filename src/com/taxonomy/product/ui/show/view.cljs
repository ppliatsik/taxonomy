...
(defn- product-view
  ...
  (when product
    [:table.table.is-fullwidth.is-stripped.is-hoverable.vertical-align-middle.fixed
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/name)]]
      [:td.nowrap (:name product)]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/published)]]
      [:td.nowrap (if (:published product)
             (trans/translate lang :com.taxonomy.ui/yes)
             (trans/translate lang :com.taxonomy.ui/no))]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/description)]]
      [:td.nowrap (:description product)]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/creator)]]
      [:td.nowrap (:creator product)]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/delivery-methods)]]
      [:td.nowrap (clj.str/join "," (:delivery-methods product))]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/deployment-models)]]
      [:td.nowrap (clj.str/join "," (:deployment-models product))]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/product-categories)]]
     ...
     [:tr
      ...
      [:td.nowrap (as-> (:security-mechanisms product) $
                        ...
                        (clj.str/join ",\n" $))]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/non-functional-guarantees)]]
      [:td.nowrap [show-guarantees-restrictions (:non-functional-guarantees product) lang]]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/protection-types)]]
      [:td.nowrap (clj.str/join "," (:protection-types product))]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/security-properties)]]
      [:td.nowrap (clj.str/join "," (:security-properties product))]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/protected-items)]]
      [:td.nowrap (clj.str/join "," (:protected-items product))]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/threats)]]
      [:td.nowrap (as-> (:threats product) $
                        (map #(trans/translate lang (keyword "com.taxonomy.threats" %)) $)
                        (clj.str/join ",\n" $))]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/restrictions)]]
      [:td.nowrap [show-guarantees-restrictions (:restrictions product) lang]]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/open-source)]]
      [:td.nowrap (if (:open-source product)
                    (trans/translate lang :com.taxonomy.ui/yes)
                    (trans/translate lang :com.taxonomy.ui/no))]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/freely-available)]]
      [:td.nowrap (if (:freely-available product)
                    (trans/translate lang :com.taxonomy.ui/yes)
                    (trans/translate lang :com.taxonomy.ui/no))]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/test-version)]]
      [:td.nowrap (if (:test-version product)
                    (trans/translate lang :com.taxonomy.ui/yes)
                    (trans/translate lang :com.taxonomy.ui/no))]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/test-duration)]]
      [:td.nowrap (when (:test-duration product)
                    (str (:test-duration product) " " (trans/translate lang ::product/days)))]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/product-interfaces)]]
      [:td.nowrap (clj.str/join "," (:product-interfaces product))]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/product-company)]]
      [:td.nowrap (:product-company product)]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/marketplaces)]]
      [:td.nowrap (clj.str/join "," (:marketplaces product))]]
     [:tr
      [:td.nowrap [:b (trans/translate lang ::product/support)]]
      [:td.nowrap (->> (:support product)
                       (map (fn [sup]
                              [:div.column
                               [:table.table.is-fullwidth.is-stripped.is-hoverable.vertical-align-middle.fixed
                                [:tr
                                 [:td.nowrap [:b (trans/translate lang ::product/support-types)]]
                                 [:td.nowrap (clj.str/join "," (:support-types sup))]]
                                [:tr
                                 [:td.nowrap [:b (trans/translate lang ::product/support-daily-duration)]]
                                 [:td.nowrap (:support-daily-duration sup)]]
                                [:tr
                                 [:td.nowrap [:b (trans/translate lang ::product/support-package-number)]]
